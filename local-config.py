...
GA_MEASUREMENT_ID: str = ""  # Replace with your actual ID if needed
GOOGLE_FORM_URL: str = (
...
# --- UI / Preview ---
PREVIEW_DURATION_S: int = 10  # Default duration for track previews in editor (seconds)
...
TRACK_SNIPPET_DURATION_S: int = (
    10  # Duration (in seconds) of audio loaded into memory for editing/preview (Uploads/TTS)
)
...
# --- TTS ---
TTS_CHUNK_SIZE: int = 5000  # Max characters per chunk for TTS generation

# --- Resource Limits ---
MAX_AUDIO_DURATION_S: int = 600  # 5 minutes max for uploaded/generated audio (UI Hint)
MAX_AFFIRMATION_CHARS: int = 30000  # Max characters for TTS input
MAX_TRACK_LIMIT: int = 5  # Maximum number of tracks allowed in the Advanced Editor
MAX_UPLOAD_SIZE_MB: int = 20  # Maximum size for uploaded files in Megabytes
